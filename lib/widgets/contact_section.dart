        ...
        children: [
          ...
          Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  homeController.launchEmail('hammadmugha590@gmail.com');
                },
                child: contactContainer(
                    Icons.email_outlined, 'hammadmugha590@gmail.com'),
              ),
              10.w,
              // Expanded(
              //   flex: 1,
          ...
          Row(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  homeController.launchPhoneDialer('+92 3160382068');
                },
                child: contactContainer(
                    Icons.phone_in_talk_outlined, '  +92 3160382068 '),
              ),
            ],
          ),
          20.h,
            ...
            child: Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    homeController.launchURL(
                        'https://www.linkedin.com/in/hammad-cross-platform-8908aa27a/');
                  },
                  child: SizedBox(
                      height: 30,
                      width: 30,
                ...
                GestureDetector(
                  onTap: () {
                    homeController
                        .launchURL('https://github.com/Hammadmughal123');
                  },
                  child: SizedBox(
                      height: 30,
                      width: 30,
